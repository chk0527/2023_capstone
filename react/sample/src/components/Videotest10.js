...
const Videotest10 = ({route, navigation}) => { //@1-const명 수정
  ...
  const fetchData = async () => {
    try {
      const response = await axios.get(`http://3.86.244.172:8080/video10`); //서버get수정 @서버get수정, 서버 쿼리문 수정
...
export default Videotest10; //@const명 수정